### This program is intended runs the model in multiple ways to achieve the data required for the SUPPLEMENTARY MATERIAL of the modelling paper
...
source(paste(getwd(),"/(command)_full_model_run.R",sep=""))
