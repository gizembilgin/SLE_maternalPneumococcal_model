...
cost_this_run = c(cost_final,cost_final_per_child,cost_case_averted,cost_death_averted,cost_hospo_averted)
...
colnames(CEA_log) <- c('program_cost','cost per child','cost_case_averted','cost_death_averted','cost_hospo_averted')
